...
# Apply security headers & CORS policies
...
def get_accounts(account_id):
    ...
    # Find the account using the Account model
    ...
    # Return the serialized account with 200 OK
...
def update_account(account_id):
    """
    Update an Account
    This endpoint will update an Account based on the provided data
    """
